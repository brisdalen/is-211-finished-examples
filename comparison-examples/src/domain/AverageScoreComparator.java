...
public class AverageScoreComparator implements Comparator<ScoreResults> {

    public static boolean ascendingOrder = true;
    /**
     * Auto-generated, I did not write all this haha
     *
